var tropes = [
 {},
  ...
  { "num":2, "name":"Lil MeowMeow", "emoji":"😿", "moves": [["Flail", 1], ["Puppy Eyes", 1], ["Comfort", 3], ["Bare Soul",5]], "baseHP":20, "hpLvL":7, "type":"F" },
...
exports.tropeFromState = function(inst) {
    ...
    [t.num, t.level, t.hp, t.pp1, t.pp2, t.pp3, t.pp4, t.attackMod, t.defenseMod, t.xp] = inst;
...
exports.createNewTrope = function(num, level=1) {
	var t = exports.tropeFromState([num, level, 0, 10, 10, 10, 10, 0, 0, 0]);
	t.hp = t.maxHP;
	return t;
}
...
exports.serializeTrope = function(t) {
	...
	return [t.num, t.level, t.hp, t.pp1, t.pp2, t.pp3, t.pp4, t.attackMod, t.defenseMod, t.xp]
}